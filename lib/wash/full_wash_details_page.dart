...
class FullWashDetailsPage extends StatefulWidget {
  final BookingDraft booking;
  final Function(Locale) onLanguageChange;

  const FullWashDetailsPage({
    super.key,
  ...
  @override
  State<FullWashDetailsPage> createState() =>
      _FullWashDetailsPageState();
}

class _FullWashDetailsPageState extends State<FullWashDetailsPage> {
  final Map<String, int> defaultServices = {
    'Exterior Wash': 50,
    'Interior Cleaning': 80,
    'Tire & Rim Cleaning': 40,
  };
  ...
  Widget build(BuildContext context) {
    ...
    return AppPageLayout(
      title: t.translate('full_wash'),
      actions: [_languageMenu()],
      child: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('services')
            .where('washType', isEqualTo: 'full')
