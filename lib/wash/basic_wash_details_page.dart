...
class BasicWashDetailsPage extends StatefulWidget {
  final BookingDraft booking;
  final Function(Locale) onLanguageChange;

  const BasicWashDetailsPage({
    super.key,
  ...
  @override
  State<BasicWashDetailsPage> createState() =>
      _BasicWashDetailsPageState();
}

class _BasicWashDetailsPageState extends State<BasicWashDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return AppPageLayout(
      title: t.translate('basic_wash'),
      actions: [_languageMenu()],
      child: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            .collection('services')
            .where('washType', isEqualTo: 'basic')
